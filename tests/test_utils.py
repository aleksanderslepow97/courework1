...
def test_fetch_and_show_currency_rates(mock_get):
    mock_get.return_value.json.return_value = {
        "Date": "2024-07-20T11:30:00+03:00",
        "PreviousDate": "2024-07-19T11:30:00+03:00",
        "PreviousURL": "//www.cbr-xml-daily.ru/archive/2024/07/19/daily_json.js",
        "Timestamp": "2024-07-21T16:00:00+03:00",
        "Valute": {
            "AUD": {
                "ID": "R01010",
                "NumCode": "036",
    ...
    mock_get.assert_called_once_with("https://www.cbr-xml-daily.ru/daily_json.js", headers={"apikey": api_key})
